...
<body>
    <div class="table-wrapper">
        <table>
            ...
            <tr>
                <td>
                    You may now login using the email and password given above. Please click this site link<br>
                    <a href="{{ $link }}">{{ $link }}</a>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <b>NOTE:</b> After signing in for the first time, please reset your temporary password. You should never give your password to anyone.<br>
