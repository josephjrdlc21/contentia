    ...
    return (
       <>
            {posts.length === 0 ? (
                ...
                posts.map((post) => (
                    <div key={post.id} className="w-full rounded-lg overflow-hidden shadow hover:scale-102 hover:shadow-primary/25 duration-300 cursor-pointer">
                        ...
                        <div className="p-5">
                            <h5 className="mb-2 font-medium text-gray-900">{post.title}</h5>
